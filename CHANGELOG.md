...
- **FIXED**: Obsolete entry point in setup.py (removed template_selector)
- **NEW**: Added theme/analytics/budget entry points to setup.py
- **IMPROVED**: Synchronized entry points between setup.py and pyproject.toml
